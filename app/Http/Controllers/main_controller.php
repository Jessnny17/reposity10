...
class main_controller extends Controller
{
    ...
    public function search(){
        ...
        return view('search',compact('cruise','cruise_dest','cruise_depart','cruise_ship'));
    ...
    public function to_view_result(){
        ...
        return redirect('/view_search_result/'.$dest_id.'/'.$d_port.'/'.$ship_id);
    }

    public function view_search_result($dest_id, $d_port, $ship_id){
        ...
        return view('view_search_result',compact('cruise','dest_name','port_name','ship_name'));
    }
    ...
    public function to_purchase(){
        ...
        return redirect('/view_payment/'.$cr_id.'/'.$ca_id.'/'.$qty);
    }
    ...
    public function purchase($cr_id, $ca_id, $qty){
        ...
        return view('view_payment',compact('c','cabin','qty'));
    ...
    public function purchase_save(){
        ...
        if(sizeof($cust)<1){
            $cust = customer::create([
                ...
                'cust_banking_acc_no'=>$input['cust_banking_acc_no'],
                'cust_status' => 'active'
            ]);
        }
