                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row result_body">
                            <div class="form-group col-lg-4">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control input-sm" placeholder="Banking Account No" name="cust_banking_acc_no" required>
                                        </div>
                            ...
                            <div class="form-group col-lg-5 col-lg-offset-1" style="padding-top: 10px; padding-left: 20px;">
                                <label>Ship:</label>
                                <br>
